    ...
    <div class="col-md-8 col-sm-8 col-xs-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="<?php echo base_url(); ?>jenis/update_jenis" method="post">
                  <?php foreach ($detail_jenis as $row) { ?>
                  <input type="hidden" name="id" value="<?php echo $row->id ?>">
                  <div class="form-group">
                    <label class="control-label col-sm-2">Nama:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama" value="<?php echo $row->jenis ?>">
                    </div>
                  </div>
                  <div class="form-group"> 
